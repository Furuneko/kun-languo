...
AgreeParams = dict(choices=list(range(1, 8)),
                   headers={1: "Strongly disagree", 4: "Neither disagree nor agree",
                            7: "Strongly agree"})
ExtentParams = dict(choices=list(range(1, 8)),
                  headers={1: "Not at all", 4: "Somewhat",
                           7: "To a great extent"})
...
class Player(BasePlayer):
    ...
    # )
    w2_4 = LikertField(
        label='7. Adjust for <i>negative</i> uncontrollable event.',
        **ExtentParams
    )
    w2_5 = LikertField(
        label='8. Adjust for <i>positive</i> uncontrollable event.',
        **ExtentParams
    )
    ...
    w3_1 = LikertField(
        label="""9.	I am satisfied with the work done by the other two employees.""",
        **AgreeParams)
    w3_2 = LikertField(
        label="""10.	Overall, I trust the other two employees.""",
        **AgreeParams)
    w3_3 = LikertField(label="""11. The other two employees put in a fair amount of effort.""",
                       **AgreeParams)
